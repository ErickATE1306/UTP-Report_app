...
import com.utp_reporta_backend.modules.reporte.repository.ReporteGestionRepository;
...
public class ReporteGestionCommandServiceImpl implements ReporteGestionCommandService {
    private final ReporteGestionRepository reporteGestionRepository;
    ...
    public ReporteGestionDTO updateReporteGestion(Long reporteId, EstadoReporte estado, PrioridadReporte prioridad, Long seguridadId) {
        ...
        if (seguridadId != null) {
            ...
            if (seguridadOptional.isEmpty()) {
                throw new ResourceNotFoundException("Usuario de seguridad no encontrado con ID: " + seguridadId);
            }
