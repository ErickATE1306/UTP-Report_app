package com.utp_reporta_backend.common.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**","/api/sedes/**","/api/zonas/**","/api/usuarios/**","/api/tipoincidentes/**","/api/reportes/**","/swagger-ui/**","/swagger-ui-custom.html","/v3/api-docs/**","/index.html/**", "/ws/**").permitAll()
